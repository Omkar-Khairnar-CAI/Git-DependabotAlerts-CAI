...
export const LineChartComponent = ({  height, width, margin,  }) => {
  ...
  return (
    <div>
      <Box fontSize="lg" fontWeight="bold" display="flex" justifyContent="space-between" alignItems="center">
        <Text>
         Alerts Trend - {selectedYear}
        </Text>
        <input width="50%" value={selectedYear} onChange={
          (e) => setSelectedYear(e.target.value)
        } type="number" name="selectYear" min="2016" max="2025" placeholder='Choose the year'/>
