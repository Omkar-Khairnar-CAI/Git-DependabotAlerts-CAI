  ...
  const alerts =  [
    ...
    },
    {
      ...
      "security_advisory": {
        ...
        "description": "A prototype pollution vulnerability exists in lodash < 4.17.20, allowing attackers to modify JavaScript object prototypes.",
        "severity": "critical",
        "cvss": {
      ...
      "html_url": "https://github.com/example-org/example-repo/security/dependabot/3",
    ...
    },
    {
      ...
      "security_advisory": {
        ...
        "description": "Certain versions of requests do not correctly verify SSL certificates, allowing man-in-the-middle attacks.",
        "severity": "high",
        "cvss": {
      ...
      "html_url": "https://github.com/example-org/example-repo/security/dependabot/4",
